...
int aes_encrypt_ccm(const BYTE payload[], WORD payload_len, const BYTE assoc[], int assoc_len,
                    const BYTE nonce[], int nonce_len, BYTE out[], WORD *out_len,
...
int aes_decrypt_ccm(const BYTE ciphertext[], WORD ciphertext_len, const BYTE assoc[], int assoc_len,
                    const BYTE nonce[], int nonce_len, BYTE plaintext[], WORD *plaintext_len,
